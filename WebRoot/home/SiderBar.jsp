		...
		<div id="sidebar">
			<div id="wrap">
				<div id="prof" class="item ">
					...
					<div class="ibar_login_box status_login ">
						...
						<div class="login_btnbox ">
							<a href="http://localhost:8080/cwhShop/findOrderByUserAccount/1" class="login_order ">我的订单</a> 
							<a href="# " class="login_favorite ">我的收藏</a>
							<a href="http://localhost:8080/cwhShop/user_address" class="my_address">我的地址</a>
							<a href="http://desktop-c4m9di8:8080/cwhShop/userLogout" class="logout">退出</a> 
						</div>
				...
				<div id="shopCart " class="item ">
					...
					<c:out value ="${sessionScope.cart.product_total}"/></p>
					</c:if>
					<c:if test="${sessionScope.cart.product_total==NULL}">
					0</p>
					</c:if>
				...
				<div id="brand " class="item ">
					<a href="#"> <span class="wdsc "><img
							src="${pageContext.request.contextPath}/images/wdsc.png " /> </span> </a>
					<div class="mp_tooltip ">
				...
				<div id="broadcast " class="item ">
					<a href="# "> <span class="chongzhi "><img
							src="${pageContext.request.contextPath}/images/chongzhi.png " />
					</span> </a>
					<div class="mp_tooltip ">
